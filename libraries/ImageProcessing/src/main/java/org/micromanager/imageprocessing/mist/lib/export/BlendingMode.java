package org.micromanager.imageprocessing.mist.lib.export;
...
public enum BlendingMode {
    ...
    */
   OVERLAY("Overlay",
            "Choose only one pixel from overlapping pixels based on highest correlation", false),

   /**
    * Average blending mode.
    */
   AVERAGE("Average",
            "Computes the the average intensity for each image", false),

   /**
    * Linear blending mode.
    */
   LINEAR("Linear",
            "Smoothly alters the intensity of the overlapping area between images", true);
