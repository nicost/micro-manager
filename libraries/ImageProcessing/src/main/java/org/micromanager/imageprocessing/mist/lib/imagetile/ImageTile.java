...
package org.micromanager.imageprocessing.mist.lib.imagetile;
...
//    }
   ...
   public String toString() {
      return "Image: " + this.fname + " path: " + this.fpath + " width: " + this.width
               + " height: " + this.height + " contains pixels: "
               + (this.pixels == null ? "-1 (not loaded)"
               : this.pixels.getWidth() * this.pixels.getHeight())
               + " abs x: " + this.absXPos + " abs y: " + this.absYPos;
   }
    ...
    * @return
    */
   public void setMstReleaseCount(int val) {
      this.mstReleaseCount = val;
   }
    ...
    * @return
    */
   public void decrementMstConnectedNeighborCount() {
      this.mstReleaseCount--;
   }
