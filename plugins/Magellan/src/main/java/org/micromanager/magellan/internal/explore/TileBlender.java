...
public class TileBlender {
   ...
   public TileBlender(MultiresNDTiffAPI storage, JSONObject displaySettings,
      ...
      overlapX_ = MD.getPixelOverlapX(summaryMetadata);
      overlapY_ = MD.getPixelOverlapY(summaryMetadata);
      tileWidth_ = MD.getWidth(summaryMetadata);
      tileHeight_ = MD.getHeight(summaryMetadata);
   }
