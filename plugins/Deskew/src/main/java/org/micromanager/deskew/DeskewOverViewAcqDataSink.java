 ...
 */
public final class DeskewOverViewAcqDataSink implements AcqEngJDataSink {
   ...
   private DeskewOverviewAcq engine_;
   SequenceSettings settings_;

   public DeskewOverViewAcqDataSink(EventManager studioEvents,
                                    SequenceSettings settings,
                                    DeskewOverviewAcq engine) {
         ...
         for (String axisName : nonStandardAxisNames) {
            if (axisName.equals("camera")) {
               ...
               if (AcqEngMetadata.getAxes(tagged.tags).get(AcqEngMetadata.CHANNEL_AXIS) != null) {
                  ...
                  chName = settings_.channels().get(channelIndex).config()
                           + "-"
